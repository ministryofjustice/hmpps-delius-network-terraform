...
module "create_elasticsearch_instance_1" {
  ...
  instance_tags = merge(
    var.tags,
    { "Name" = "${var.environment_identifier}-es-node" },
    { "HMPPS_ROLE" = var.app_name },
    { "HMPPS_STACKNAME" = var.environment_identifier },
    { "HMPPS_STACK" = var.short_environment_identifier },
    { "HMPPS_FQDN" = "${var.hostname}-node1.${var.private_zone_name}" }
  )
...
module "create_elasticsearch_instance_2" {
  ...
  instance_tags = merge(
    ...
    { "HMPPS_STACKNAME" = var.environment_identifier },
    { "HMPPS_STACK" = var.short_environment_identifier },
    { "HMPPS_FQDN" = "${var.hostname}-node2.${var.private_zone_name}" }
  )
...
module "create_elasticsearch_instance_3" {
  ...
  instance_tags = merge(
    ...
    { "HMPPS_STACKNAME" = var.environment_identifier },
    { "HMPPS_STACK" = var.short_environment_identifier },
    { "HMPPS_FQDN" = "${var.hostname}-node3.${var.private_zone_name}" },
  )
