...
locals {
  sg_monitoring_elb    = data.terraform_remote_state.security-groups.outputs.sg_monitoring_elb
  sg_monitoring_inst   = data.terraform_remote_state.security-groups.outputs.sg_monitoring
  sg_elasticsearch     = data.terraform_remote_state.security-groups.outputs.sg_elasticsearch
  sg_monitoring_client = data.terraform_remote_state.security-groups.outputs.sg_monitoring_client
  sg_mon_efs           = data.terraform_remote_state.security-groups.outputs.sg_mon_efs
  sg_mon_jenkins       = data.terraform_remote_state.security-groups.outputs.sg_mon_jenkins
}
...
resource "aws_security_group_rule" "sg_monitoring_elb_es_nat_in" {
  ...
  cidr_blocks = local.natgateway_cidrs
